...
# modelVars <- c("shared", "shared" ,"shared","shared","covariate")
...
#   estimatesCaseStudy[[iCount]] <- tryCatch({ run_nimble_model(simulations_all[[1]], model = methodVars[iCount],covariance_prior = "LV", method = modelVars[iCount]) }, error=function(e){cat("ERROR :",conditionMessage(e), "\n")})
#   #}
#
#
#   #stopCluster(cl)
