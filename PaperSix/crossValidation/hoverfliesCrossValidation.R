...
#   estimatesCaseStudy[[iCount]] <- tryCatch({ run_nimble_model(simulations_all[[2]], model = methodVars[iCount],covariance_prior = "LV", method = modelVars[iCount]) }, error=function(e){cat("ERROR :",conditionMessage(e), "\n")})
#   #}
#
#
#   #stopCluster(cl)
